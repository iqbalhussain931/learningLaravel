...
<html lang="en">
	<head>
		...
		<!-- Custom CSS -->
		<link rel="stylesheet" href="css/style-layout12.css">
		<!-- Icon Fonts  -->
	...
	<body>
			...
			<nav id="off-canvas-menu">				
				<ul class="expander-list">				
					...
					<li>
						<span class="name">
							<span class="expander">-</span>
							<a href="listing.html"><span class="act-underline">Tools<span class="badge badge--menu badge--color">New</span></span></a>
						</span>
						<ul class="multicolumn-level">
							<li>
								<span class="name">
									<span class="expander">-</span>
									<a class="megamenu__subtitle" href="listing-layout12.html">										
										<span>Cordless Power System</span>
									</a>
								</span>
								<ul class="image-links-level-3 megamenu__submenu">									
									<li class="level3"><a href="listing-layout12.html">Cordless Chain Saws</a></li>									
									<li class="level3"><a href="listing-layout12.html">Cordless pole pruner</a></li>
									<li class="level3"><a href="listing-layout12.html">Cordless Brushcutters</a></li>
									<li class="level3"><a href="listing-layout12.html">Cordless Hedge Trimmers</a></li>									
									<li class="level3"><a href="listing-layout12.html">Battery Sweepers <span class="badge badge--menu badge--color-dark">SALE</span></a></li>	
									<li class="level3"><a href="listing-layout12.html">Cordless Blower</a></li>	
									<li class="level3"><a href="listing-layout12.html">Cordless cut-off machines</a></li>	
								</ul>
							</li>
							<li>
								<span class="name">
									<span class="expander">-</span>
									<a class="megamenu__subtitle" href="listing-layout12.html">										
										<span>saw chains, guide bars</span>
									</a>
								</span>
								<ul class="image-links-level-3 megamenu__submenu">									
									<li class="level3"><a href="listing-layout12.html">Arborist saws</a></li>									
									<li class="level3"><a href="listing-layout12.html">Carving chain saws</a></li>
									<li class="level3"><a href="listing-layout12.html">Emergency services saw</a></li>
									<li class="level3"><a href="listing-layout12.html">Cordless Chain Saws</a></li>									
									<li class="level3"><a href="listing-layout12.html">Electric chain saws</a></li>
									<li class="level3"><a href="listing-layout12.html">Pole pruners</a></li>
								</ul>
							</li>
							<li>
								<span class="name">
								...
								<ul class="image-links-level-3 megamenu__submenu">									
									<li class="level3"><a href="listing-layout12.html">Light brushcutters</a></li>									
									<li class="level3"><a href="listing-layout12.html">Powerful brushcutters <span class="badge badge--menu badge--color">SALE</span></a></li>
									<li class="level3"><a href="listing-layout12.html">Clearing saws</a></li>																		
									<li class="level3"><a href="listing-layout12.html">Cordless brushcutters</a></li>
									<li class="level3"><a href="listing-layout12.html">Electric brushcutters</a></li>
									<li class="level3"><a href="listing-layout12.html">Backpack brushcutters</a></li>
									<li class="level3"><a href="listing-layout12.html">Cutting Tools</a></li>
								</ul>
							</li>
						</ul>
					</li>
				...
				<div class="container offset-top-5">
					<div class="row">
						...
						<div class="col-xs-12 col-md-3 col-lg-3 col-xl-3 col-sm-3">
							<!-- logo start --> 
							<a href="index-12.html"><img class="logo replace-2x img-responsive" src="images/custom/layout12/logo.png" alt=""/></a> 
							<!-- logo end --> 
						</div>
						<!-- /col-left -->						
						<!-- col-right -->										
						<div class="col-sm-6 col-md-8 col-lg-8 col-xl-8 pull-right text-right">
							<div class="row-functional-link">								
								...
								<!-- shopping cart end -->
								<!-- Compare start -->
								<div class="link-inline  mobile-menu-off" onclick="location.href='compare.html'">
									<div class="dropdown">
										<a class="dropdown-toggle" data-toggle="dropdown">
											<span class="badge badge--cart">0</span>
											<span class="icon icon-sort"></span>											
											<span class="name-text">Compare</span>
										</a>										
									</div>
								</div>
								<!-- /Compare end -->
								<!-- Wishlist start -->
								<div class="link-inline  mobile-menu-off" onclick="location.href='wishlist.html'" >
									<div class="dropdown">
										<a class="dropdown-toggle" data-toggle="dropdown">
											<span class="badge badge--cart">0</span>
											<span class="icon icon-favorite_border"></span>											
											<span class="name-text">Wishlist</span>
										</a>										
									</div>
								</div>
								<!-- /Wishlist end -->
								...
								<nav class="navbar">
									<div class="responsive-menu mainMenu">									
										...
										<ul class="nav navbar-nav">
											...
											<li class="dropdown dropdown-mega-menu">
												<span class="dropdown-toggle extra-arrow"></span>
												<a href="listing.html" class="dropdown-toggle" data-toggle="dropdown"><span class="act-underline">Tools <span class="badge badge--menu badge--color">New</span></span></a>
												<ul class="dropdown-menu megamenu" role="menu">
													...
													<li class="col-sm-4">												
														...
														<ul class="megamenu__submenu megamenu__submenu--marked">
															<li class="dl-back"><a href="#"><span class="icon icon-chevron_left"></span>back</a></li>
															<li class="level2"><a href="listing.html">Cordless Chain Saws</a></li>
															<li class="level2"><a href="listing.html">Cordless pole pruner</a></li>
															<li class="level2"><a href="listing.html">Cordless Brushcutters</a></li>
															<li class="level2"><a href="listing.html">T-Cordless Hedge Trimmers</a></li>
															<li class="level2"><a href="listing.html">Battery Sweepers<span class="badge badge--menu badge--color-dark">SALE</span></a></li>
															<li class="level2"><a href="listing.html">Cordless Blower</a></li>
															<li class="level2"><a href="listing.html">Cordless cut-off machines</a></li>
														</ul>
													</li>
													<li class="col-sm-4">
														<a href="listing.html" class="megamenu__subtitle">
														...
														<ul class="megamenu__submenu megamenu__submenu--marked">
															<li class="dl-back"><a href="#"><span class="icon icon-chevron_left"></span>back</a></li>
															<li class="level2"><a href="listing.html">Arborist saws</a></li>
															<li class="level2"><a href="listing.html">Carving chain saws</a></li>
															<li class="level2"><a href="listing.html">Emergency services saw</a></li>
															<li class="level2"><a href="listing.html">Cordless Chain Saws</a></li>
															<li class="level2"><a href="listing.html">Electric chain saws</a></li>
															<li class="level2"><a href="listing.html">Pole pruners</a></li>
														</ul>
													</li>
													<li class="col-sm-4">
														...
														<ul class="megamenu__submenu megamenu__submenu--marked">
															<li class="dl-back"><a href="#"><span class="icon icon-chevron_left"></span>back</a></li>
															<li class="level2"><a href="listing.html">Light brushcutters</a></li>
															<li class="level2"><a href="listing.html">Powerful brushcutters <span class="badge badge--menu badge--color">SALE</span></a></li>
															<li class="level2"><a href="listing.html">Clearing saws</a></li>
															<li class="level2"><a href="listing.html">Cordless brushcutters</a></li>
															<li class="level2"><a href="listing.html">Electric brushcutters</a></li>
															<li class="level2"><a href="listing.html">Backpack brushcutters</a></li>
															<li class="level2"><a href="listing.html">Cutting Tools</a></li>
														</ul>
													</li>													
									...
									<div class="dropdown text-right">
										...
										<div class="dropdown-menu dropdown-menu--xs-full slide-from-top" role="menu">
											<div class="container">
												...
												<ul>
													<li class="cart__item">
														<div class="cart__item__image pull-left"><a href="#"><img src="images/custom/layout12/products/product-01.jpg" alt=""/></a></div>
														<div class="cart__item__control">
															<div class="cart__item__delete"><a href="#" class="icon icon-delete"><span>Delete</span></a></div>
															<div class="cart__item__edit"><a href="#" class="icon icon-edit"><span>Edit</span></a></div>
														</div>
													...
													<li class="cart__item">
														<div class="cart__item__image pull-left"><a href="#"><img src="images/custom/layout12/products/product-02.jpg" alt=""/></a></div>
														<div class="cart__item__control">
															<div class="cart__item__delete"><a href="#" class="icon icon-delete"><span>Delete</span></a></div>
															<div class="cart__item__edit"><a href="#" class="icon icon-edit"><span>Edit</span></a></div>
														</div>
			...
			<div class="container">
				...
				<div class="row">
					...
					<aside class="col-xs-12 col-sm-12 col-md-4 col-lg-3 col-xl-2 ">						
								...
								<ul class="nav navbar-nav">
									...
									<li class="dropdown dropdown-mega-menu">
										...
										<ul class="dropdown-menu megamenu" role="menu">
											<li class="dl-back"><a href="#"><span class="icon icon-chevron_left"></span>back</a></li>
											<li class="col-sm-4">
												<a href="#" class="megamenu__subtitle"><span>Cordless Power System</span></a>
												<ul class="megamenu__submenu">
													<li class="dl-back"><a href="#"><span class="icon icon-chevron_left"></span>back</a></li>
													<li class="level2"><a href="#">Cordless Chain Saws</a></li>
													<li class="level2">
														<a href="#">Cordless pole pruner</a>														
													</li>
													<li class="level2"><a href="#">Cordless Brushcutters</a></li>
													<li class="level2"><a href="#">Cordless Hedge Trimmers</a></li>
													<li class="level2"><a href="#">Battery Sweepers <span class="badge badge--menu badge--color-dark">SALE</span></a></li>
													<li class="level2"><a href="#">Cordless Blower</a></li>
													<li class="level2"><a href="#">Cordless cut-off machines</a></li>
												</ul>
											</li>
											<li class="col-sm-4">
												<a href="#" class="megamenu__subtitle"><span>saw chains, guide bars</span></a>
												<ul class="megamenu__submenu">
													<li class="dl-back"><a href="#"><span class="icon icon-chevron_left"></span>back</a></li>
													<li class="level2"><a href="#">Arborist saws</a></li>
													<li class="level2"><a href="#">Carving chain saws</a></li>
													<li class="level2"><a href="#">Emergency services saw</a></li>
													<li class="level2"><a href="#">Cordless Chain Saws</a></li>
													<li class="level2"><a href="#">Electric chain saws</a></li>
													<li class="level2"><a href="#">Pole pruners</a></li>
												</ul>
											</li>
											<li class="col-sm-4">
												<a href="#" class="megamenu__subtitle"><span>clearing saws</span></a>
												<ul class="megamenu__submenu">
													<li class="dl-back"><a href="#"><span class="icon icon-chevron_left"></span>back</a></li>
													<li class="level2"><a href="#">Light brushcutters</a></li>
													<li class="level2"><a href="#">Powerful brushcutters <span class="badge badge--menu badge--color">SALE</span></a></li>
													<li class="level2"><a href="#">Clearing saws</a></li>
													<li class="level2"><a href="#">Cordless brushcutters</a></li>
													<li class="level2"><a href="#">Electric brushcutters</a></li>
													<li class="level2"><a href="#">Backpack brushcutters</a></li>
													<li class="level2"><a href="#">Cutting Tools</a></li>
												</ul>
											</li>																					
										</ul>
									</li>
						...
						<div class="bannerAsid nav-dot">
							...
							<div class="text-center">
								<a href="listing.html"><img class="img-responsive-inline" src="images/custom/layout12/banner-aside-01.jpg" alt=""></a>									
							</div>
							<!-- /slide-->
							<!-- slide-->
							<div class="text-center">
								<a href="listing.html"><img class="img-responsive-inline" src="images/custom/layout12/banner-aside-02.jpg" alt=""></a>
							</div>
							<!-- /slide-->
							<!-- slide-->
							<div class="text-center">
								<a href="listing.html"><img class="img-responsive-inline" src="images/custom/layout12/banner-aside-03.jpg" alt=""></a>
							</div>
							<!-- /slide-->
						</div>						
						<!--======= /banner-asid =======-->
						...
						<!--======= testimonials =======-->
						<div class="fill-bg aside-inner color-white">
							...
							<div class="testimonialsAsid nav-dot nav-dot-invert">
								...
								<a href="blog-post-right-column.html" class="link-hover-block">
									<div class="text-center">
										<img class="img-responsive-inline" src="images/custom/layout12/slider-blog-img01.jpg" alt="">
										<p>
								...
								<a href="blog-post-right-column.html" class="link-hover-block">
									<div class="text-center">
										<img class="img-responsive-inline" src="images/custom/layout12/slider-blog-img02.jpg" alt="">
										<p>
								...
								<a href="blog-post-right-column.html" class="link-hover-block">
									<div class="text-center">
										<img class="img-responsive-inline" src="images/custom/layout12/slider-blog-img03.jpg" alt="">
										<p>
							...
							<div class="col-sm-3 col-xl-6">
								...
								<div class="recent-post-box">
									<div class="col-lg-12 col-xl-12">
										...
										<span class="figure">
										<img src="images/custom/layout12/recent-posts-01.jpg" alt="">
							...
							<div class="col-sm-3 col-xl-6">
								...
								<div class="recent-post-box">
									<div class="col-lg-12 col-xl-12">
										<a href="blog-post-right-column.html">
										<span class="figure">
										<img src="images/custom/layout12/recent-posts-02.jpg" alt="">
										<span class="figcaption label-top-left">
										<span>
										<b>26</b>
										<em>jun</em>
							...
							<div class="col-sm-3 col-xl-6">
								...
								<div class="recent-post-box">
									<div class="col-lg-12 col-xl-12">
										<a href="blog-post-right-column.html">
										<span class="figure">
										<img src="images/custom/layout12/recent-posts-03.jpg" alt="">
										<span class="figcaption label-top-left">
										<span>
										<b>26</b>
										<em>jun</em>
					...
					<div class="col-xs-12 col-sm-12 col-md-8 col-lg-9 col-xl-10" id="centerColumn">
						...
						<!-- Slider section --> 						
						<div class="offset-top-0 hidden-xs" id="slider">
							<!--
								#################################
								- THEMEPUNCH BANNER -
								#################################
							...
							<div class="tp-banner-container slider-layout-6">
								<div class="tp-banner">
									<ul>
										<!-- SLIDE -1 -->
										<li data-transition="fade" data-slotamount="1" data-masterspeed="1000" data-saveperformance="off"  data-title="Slide">
											<!-- MAIN IMAGE --> 
											<img src="images/custom/layout12/slides/slide-1.jpg"  alt="slide1"  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" > 
											<!-- LAYERS --> 
											<!-- TEXT -->
											...
											<div class="tp-caption lfr str"
												...
												data-endeasing="Power4.easeIn" 
												style="z-index: 2;">
												<div class="tp-caption4--wd-3"><a href="listing-layout12.html" class="link-button btn--bg-green but--ys" data-text="Shop now!">Shop now!</a></div>												
											</div>	
										</li>
										<!-- /SLIDE -1 -->
										<!-- SLIDE 2  -->            
										<li data-transition="fade" data-slotamount="1" data-masterspeed="1000" data-saveperformance="off"  data-title="Slide">
											<!-- MAIN IMAGE --> 
											<img src="images/custom/layout12/slides/slide-2.jpg"  alt="slide2"  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat"> 
											<!-- LAYERS -->
											<!-- TEXT -->
											...
											<div class="tp-caption lfr str"
												...
												data-endeasing="Power4.easeIn" 
												style="z-index: 2;">
												<div class="tp-caption4--wd-3"><a href="listing-layout12.html" class="link-button btn--bg-coquelicot but--ys" data-text="Shop now!">Shop now!</a></div>												
											</div>							
										</li>
										<!-- /SLIDE 2  -->
										<!-- SLIDE 3  -->
										<li data-transition="fade" data-slotamount="1" data-masterspeed="1000" data-saveperformance="off"  data-title="Slide">
											<!-- MAIN IMAGE --> 
											<img src="images/custom/layout12/slides/slide-3.jpg"  alt="slide3"  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat"> 
											<!-- LAYERS --> 
											<!-- TEXT -->
											<div class="tp-caption lfl stl" 
												data-x="left"              
											...
											<div class="tp-caption lfr str"
												...
												data-endeasing="Power4.easeIn" 
												style="z-index: 2;">
												<div class="tp-caption4--wd-3"><a href="listing-layout12.html" class="link-button btn--bg-dark but--ys" data-text="Shop now!">Shop now!</a></div>										
											</div>	
										</li>
										<!-- /SLIDE 3  -->		  
									</ul>
							...
							<div class="row">
								<div class="category-carousel">
									<div class="col-sm-4 col-md-4 col-lg-4">
										<a href="listing-layout12.html" class="banner-layout-1 zoom-in">
											<span class="figure">
												<img src="images/custom/layout12/category-1.jpg" alt=""/>
												<span class="figcaption">
													<span class="banner__title text-uppercase size6">
									...
									<div class="col-sm-4 col-md-4 col-lg-4">
										<a href="listing-layout12.html" class="banner-layout-1 zoom-in">
											<span class="figure">
												<img src="images/custom/layout12/category-2.jpg" alt=""/>
												<span class="figcaption">
													<span class="banner__title text-uppercase size6">
														Chain saws, guide bars
														<span class="icon icon-navigate_next pull-right"></span>
													</span>
												</span>
											</span>
									...
									<div class="col-sm-4 col-md-4 col-lg-4">
										<a href="listing-layout12.html" class="banner-layout-1 zoom-in">
											<span class="figure">
												<img src="images/custom/layout12/category-3.jpg" alt=""/>
												<span class="figcaption">
													<span class="banner__title text-uppercase size6">
											...
											<div class="product__inside__image">
												...
												<div class="product__inside__carousel slide" data-ride="carousel">
													<div class="carousel-inner" role="listbox">
														<div class="item active"> <a href="product.html"><img src="images/custom/layout12/products/product-01.jpg" alt=""></a> </div>
														<div class="item"> <a href="product.html"><img src="images/custom/layout12/products/product-08.jpg" alt=""></a> </div>
														<div class="item"> <a href="product.html"><img src="images/custom/layout12/products/product-09.jpg" alt=""></a> </div>
													</div>
													<!-- Controls --> 
								...
								<div class="col-lg-3">
									...
									<div class="product">
										<div class="product__inside">
											<!-- product image -->
											<div class="product__inside__image">
												<a href="product-layout12.html"> <img src="images/custom/layout12/products/product-02.jpg" alt=""> </a> 
												<!-- quick-view --> 
												<a href="#" data-toggle="modal" data-target="#quickViewModal" class="quick-view"><b><span class="icon icon-visibility"></span> Quick view</b> </a>  
												<!-- /quick-view --> 
											</div>
											...
											<!-- product name -->
											<div class="product__inside__name">
												<h2><a href="product-layout12.html">Mauris lacinia lectus</a></h2>
											</div>
											<!-- /product name --> 
											<!-- product price -->
								...
								<div class="col-lg-3">
									...
									<div class="product">
										<div class="product__inside">
											<!-- product image -->
											<div class="product__inside__image">
												<a href="product-layout12.html"> <img src="images/custom/layout12/products/product-03.jpg" alt=""> </a> 
												<!-- quick-view --> 
												<a href="#" data-toggle="modal" data-target="#quickViewModal" class="quick-view"><b><span class="icon icon-visibility"></span> Quick view</b> </a>  
												<!-- /quick-view --> 
											</div>
								...
								<div class="col-lg-3">
									...
									<div class="product sold-out">
										<div class="product__inside">
											<!-- product image -->
											<div class="product__inside__image">
												<a href="product-layout12.html"> <img src="images/custom/layout12/products/product-04.jpg" alt=""> </a> 
												<!-- label sold-out -->
								...
								<div class="col-lg-3">
									...
									<div class="product">
										<div class="product__inside">
											<!-- product image -->
											<div class="product__inside__image">
												<a href="product-layout12.html"> <img src="images/custom/layout12/products/product-05.jpg" alt=""> </a> 
												<!-- quick-view --> 
												<a href="#" data-toggle="modal" data-target="#quickViewModal" class="quick-view"><b><span class="icon icon-visibility"></span> Quick view</b> </a>  
												<!-- /quick-view --> 
											</div>
										...
										<div class="col-lg-3">
											...
											<div class="product">
												<div class="product__inside">
													<!-- product image -->
													<div class="product__inside__image">
														<a href="product-layout12.html"> <img src="images/custom/layout12/products/product-06.jpg" alt=""> </a> 
														<!-- quick-view --> 
														<a href="#" data-toggle="modal" data-target="#quickViewModal" class="quick-view"><b><span class="icon icon-visibility"></span> Quick view</b> </a>  
														<!-- /quick-view --> 
													</div>
										...
										<div class="col-lg-3">
											...
											<div class="product">
												<div class="product__inside">
													<!-- product image -->
													<div class="product__inside__image">
														<a href="product-layout12.html"> <img src="images/custom/layout12/products/product-07.jpg" alt=""> </a> 
														<!-- quick-view --> 
														<a href="#" data-toggle="modal" data-target="#quickViewModal" class="quick-view"><b><span class="icon icon-visibility"></span> Quick view</b> </a>  
														<!-- /quick-view --> 
													</div>
													...
													<!-- /product name --> 
													<!-- product price -->
													<div class="product__inside__price price-box">$77.00<span class="price-box__old">$87.00</span></div>
													<!-- /product price --> 
													<div class="product__inside__hover">
														<!-- product info -->
														<div class="product__inside__info">
										...
										<div class="col-lg-3">
											...
											<div class="product">
												<div class="product__inside">
													<!-- product image -->
													<div class="product__inside__image">
														<a href="product-layout12.html"> <img src="images/custom/layout12/products/product-08.jpg" alt=""> </a> 
														<!-- quick-view --> 
														<a href="#" data-toggle="modal" data-target="#quickViewModal" class="quick-view"><b><span class="icon icon-visibility"></span> Quick view</b> </a>  
														<!-- /quick-view --> 
													</div>
													...
													<!-- /product name --> 
													<!-- product price -->
													<div class="product__inside__price price-box">$187.00<span class="price-box__old">$197.00</span></div>
													<!-- /product price -->
													<div class="product__inside__hover">
														<!-- product info -->
														<div class="product__inside__info">
										...
										<div class="col-lg-3">
											...
											<div class="product">
												<div class="product__inside">
													<!-- product image -->
													<div class="product__inside__image">
														<a href="product-layout12.html"> <img src="images/custom/layout12/products/product-09.jpg" alt=""> </a> 
														<!-- quick-view --> 
														<a href="#" data-toggle="modal" data-target="#quickViewModal" class="quick-view"><b><span class="icon icon-visibility"></span> Quick view</b> </a>  
														<!-- /quick-view --> 
													</div>
										...
										<div class="col-lg-3">
											...
											<div class="product">
												<div class="product__inside">
													<!-- product image -->
													<div class="product__inside__image">
														<a href="product-layout12.html"> <img src="images/custom/layout12/products/product-10.jpg" alt=""> </a> 
														<!-- quick-view --> 
														<a href="#" data-toggle="modal" data-target="#quickViewModal" class="quick-view"><b><span class="icon icon-visibility"></span> Quick view</b> </a>  
														<!-- /quick-view --> 
													</div>
						...
						<div class="content section-indent-bottom">
							<div class="row">
								<div class="brands-carousel">
									<div><a href="#"><img src="images/custom/layout12/brand-01.png" alt=""></a></div>
									<div><a href="#"><img src="images/custom/layout12/brand-02.png" alt=""></a></div>
									<div><a href="#"><img src="images/custom/layout12/brand-03.png" alt=""></a></div>
									<div><a href="#"><img src="images/custom/layout12/brand-04.png" alt=""></a></div>
									<div><a href="#"><img src="images/custom/layout12/brand-05.png" alt=""></a></div>
									<div><a href="#"><img src="images/custom/layout12/brand-06.png" alt=""></a></div>
									<div><a href="#"><img src="images/custom/layout12/brand-07.png" alt=""></a></div>
									<div><a href="#"><img src="images/custom/layout12/brand-08.png" alt=""></a></div>
									<div><a href="#"><img src="images/custom/layout12/brand-09.png" alt=""></a></div>
									<div><a href="#"><img src="images/custom/layout12/brand-10.png" alt=""></a></div>
									<div><a href="#"><img src="images/custom/layout12/brand-01.png" alt=""></a></div>
									<div><a href="#"><img src="images/custom/layout12/brand-02.png" alt=""></a></div>
									<div><a href="#"><img src="images/custom/layout12/brand-03.png" alt=""></a></div>
									<div><a href="#"><img src="images/custom/layout12/brand-04.png" alt=""></a></div>
		...
		<footer class="layout-4">
							...
							<div class="mobile-collapse">
								...
								<div class="mobile-collapse__content">
									<form class="form-inline">
										<input class="subscribe-form__input" type="text" name="subscribe" placeholder="Your E-mail:">
			...
			<div class="container footer-copyright">
				<div class="row">
					<div class="col-sm-6">
						<a href="index.html"><span>Your</span>Store</a> &copy; 2016 . All Rights Reserved. 
					</div>
					<div class="pull-right hidden-xs hidden-sm hidden-md">
						<ul class="list-icon-small">
							<li><img src="images/custom/icon-payment-01.png" alt=""></li>
							<li><img src="images/custom/icon-payment-02.png" alt=""></li>
							<li><img src="images/custom/icon-payment-03.png" alt=""></li>
							<li><img src="images/custom/icon-payment-04.png" alt=""></li>
							<li><img src="images/custom/icon-payment-05.png" alt=""></li>
							<li><img src="images/custom/icon-payment-06.png" alt=""></li>
							<li><img src="images/custom/icon-payment-07.png" alt=""></li>
							<li><img src="images/custom/icon-payment-08.png" alt=""></li>
							<li><img src="images/custom/icon-payment-09.png" alt=""></li>
						</ul>
					</div>
				</div>
			</div>
      ...
      <!-- Modal (quickViewModal) -->		
		    ...
		    <div class="modal-content modal-md">
		      ...
		      <div class="modal-block">
			      ...
			      <div class="modal-newsletter text-center">
			      	    <img class="logo replace-2x img-responsive1" src="images/custom/layout12/logo.png" alt=""/>
		...
		<script src="js/js-index-12.js"></script>					
	</body>
</html>
