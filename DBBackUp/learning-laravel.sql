...
CREATE TABLE `roles` (
  `id` int(11) NOT NULL,
  `role` varchar(255) DEFAULT 'Marketing'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(1, 'Muhammad Iqbal Hussain', 'iqbalhussain931@gmail.com', '$2y$10$00GwkAEVXln2/2C.stT3le1ltkJampM6CJcWzmHB82kCc/rdEOk.e', 1, NULL, '2017-02-18 19:32:40', '2017-02-18 19:32:40');
